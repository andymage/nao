...
?>
	<div class="col-md-12">
		<div class="box box-success">
		    ...
		    {!! Form::open(
		            [
		                'action' => ['DevolucionFacturasController@edit' , $model->id],
		                'class' => 'form',
		            ]
	          	) 
	        !!}
		        ...
		        <div class="box-body">
		            ...
		            <div class="form-group col-md-6">
		                ...
		                <?=
		                	Form::text('proveedor',
		                		$model->factura->proveedor->nombre,
		                		[
		                			'class' => 'form-control',
		            ...
		            <div class="form-group col-md-6">
		                ...
		                <?=
		                	Form::text('clave_corta',
		                		$model->factura->proveedor->clave_corta,
		                		[
		                			'class' => 'form-control',
		            ...
		            <div class="form-group col-md-6">
		                ...
		                <?=
		                	Form::text('id_hilo',
		                		$model->factura->hilo->cve_corta_hilo,
		                		[
		                			'class' => 'form-control',
		                			'id' => 'id_hilo',
		                			'readonly' => 'readonly',
