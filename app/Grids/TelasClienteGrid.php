...
class TelasClienteGrid extends Grid implements TelasClienteGridInterface
{
    /**
    ...
    */
    ...
    public function setRoutes()
    {
        ...
        $this->setIndexRouteName('telascliente.index');

        // crud support
        $this->setCreateRouteName('telascliente.create');
        $this->setViewRouteName('telascliente.show');
        $this->setDeleteRouteName('telascliente.destroy');
    ...
    public function configureButtons()
    {
        ...
        $this->makeCustomButton([
            ...
            'url' => function($gridName, $gridItem) {
                return route('telascliente.update', ['id' => $gridItem->id]);
            },
