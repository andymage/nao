...
class CrudosGrid extends Grid implements CrudosGridInterface
{
    /**
    ...
    */
    ...
    public function setRoutes()
    {
        ...
        $this->setIndexRouteName('crudos.index');

        // crud support
        $this->setCreateRouteName('crudos.create');
        $this->setViewRouteName('crudos.show');
        $this->setDeleteRouteName('crudos.destroy');
    ...
    public function configureButtons()
    {
        ...
        $this->makeCustomButton([
            ...
            'url' => function($gridName, $gridItem) {
                return route('crudos.update', ['id' => $gridItem->id]);
            },
