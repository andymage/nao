...
class MaquinasCircularesGrid extends Grid implements MaquinasCircularesGridInterface
{
    /**
     ...
     * @var string
     */
    protected $name = 'MaquinasCirculares';
    ...
    */
    ...
    public function setRoutes()
    {
        ...
        $this->setIndexRouteName('maquinascirculares.index');

        // crud support
        $this->setCreateRouteName('maquinascirculares.create');
        $this->setViewRouteName('maquinascirculares.show');
        $this->setDeleteRouteName('maquinascirculares.destroy');
    ...
    public function configureButtons()
    {
        ...
        $this->makeCustomButton([
            ...
            'url' => function($gridName, $gridItem) {
                return route('maquinascirculares.update', ['id' => $gridItem->id]);
            },
