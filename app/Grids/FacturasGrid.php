...
class FacturasGrid extends Grid implements FacturasGridInterface
{
    /**
    ...
    */
    ...
    public function setRoutes()
    {
        ...
        $this->setIndexRouteName('facturas.index');

        // crud support
        $this->setCreateRouteName('facturas.create');
        $this->setViewRouteName('facturas.show');
        $this->setDeleteRouteName('facturas.destroy');
    ...
    public function configureButtons()
    {
        ...
        $this->makeCustomButton([
            ...
            'url' => function($gridName, $gridItem) {
                return route('facturas.update', ['id' => $gridItem->id]);
            },
