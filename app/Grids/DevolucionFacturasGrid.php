...
class DevolucionFacturasGrid extends Grid implements DevolucionFacturasGridInterface
{
    /**
     ...
     * @var string
     */
    protected $name = 'Devolucion de Facturas';
    ...
    */
    ...
    public function setRoutes()
    {
        ...
        $this->setIndexRouteName('devolucionfacturas.index');

        // crud support
        $this->setCreateRouteName('devolucionfacturas.create');
        $this->setViewRouteName('devolucionfacturas.show');
        $this->setDeleteRouteName('devolucionfacturas.destroy');
    ...
    public function configureButtons()
    {
        ...
        $this->makeCustomButton([
            ...
            'url' => function($gridName, $gridItem) {
                return route('devolucionfacturas.update', ['id' => $gridItem->id]);
            },
