...
class ClavesHilosGrid extends Grid implements ClavesHilosGridInterface
{
    /**
    ...
    */
    ...
    public function setRoutes()
    {
        ...
        $this->setIndexRouteName('claveshilos.index');

        // crud support
        $this->setCreateRouteName('claveshilos.create');
        $this->setViewRouteName('claveshilos.show');
        $this->setDeleteRouteName('claveshilos.destroy');
    ...
    public function configureButtons()
    {
        ...
        $this->makeCustomButton([
            ...
            'url' => function($gridName, $gridItem) {
                return route('claveshilos.update', ['id' => $gridItem->id]);
            },
